...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      args.imdb_name = "voc_2017_trainval"
      args.imdbval_name = "voc_2017_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  elif args.dataset == "pascal_voc_0712":
      args.imdb_name = "voc_2017_trainval+voc_2012_trainval"
      args.imdbval_name = "voc_2017_test"
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  ...
  args.cfg_file = "models/{}_{}.yml".format(args.net, args.group) if args.group != 0 else "models/{}.yml".format(args.net)
  ...
  output_dir_vu = get_output_dir(imdb_vu, 'results')

  fasterRCNN.eval()
  for avg in range(args.average):
    dataset_vu.query_position = avg
    dataloader_vu = torch.utils.data.DataLoader(dataset_vu, batch_size=1,shuffle=False, num_workers=1,pin_memory=True)
